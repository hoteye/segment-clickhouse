...
/**
 * TransformerUtils.insertSegmentObjectToEvents 方法的专门测试类
 * 
 * <p>
 * 测试覆盖场景：
 * <ul>
 ...
 * </ul>
 * 
 * @see TransformerUtils#insertSegmentObjectToEvents
...
class InsertSegmentObjectToEventsTest {
    ...
    void testBasicFieldMapping() throws Exception {
        ...
        // 执行测试
        TransformerUtils.insertSegmentObjectToEvents(mockDatabaseService, segment, invalidFields, missingFields);
    ...
    void testMultipleSpans() throws Exception {
        ...
        // 执行测试
        TransformerUtils.insertSegmentObjectToEvents(mockDatabaseService, segment, invalidFields, missingFields); // 验证执行了两次
                                                                                                                  // (每个
                                                                                                                  // Span
                                                                                                                  // 一次)
    ...
    void testTagsProcessing() throws Exception {
        ...
        // 执行测试
        TransformerUtils.insertSegmentObjectToEvents(mockDatabaseService, segment, invalidFields, missingFields); // 验证
                                                                                                                  // Tags
                                                                                                                  // 字段设置
    ...
    void testInvalidFieldNameHandling() throws Exception {
        ...
        // 执行测试
        TransformerUtils.insertSegmentObjectToEvents(mockDatabaseService, segment, invalidFields, missingFields); // 验证无效字段名被正确记录（空格未被替换，因此无效）
    ...
    void testDateTimeFieldProcessing() throws Exception {
        ...
        // 执行测试
        TransformerUtils.insertSegmentObjectToEvents(mockDatabaseService, segment, invalidFields, missingFields); // 验证日期时间字段设置
    ...
    void testErrorValueAndTypeConversion() throws Exception {
        ...
        SegmentObject segment = SegmentObject.newBuilder()
                ...
                .addSpans(SpanObject.newBuilder()
                        ...
                        .addTags(KeyStringValuePair.newBuilder()
                                ...
                                .setValue("3.141592653589793") // 浮点数
                                .build())
                        .addTags(KeyStringValuePair.newBuilder()
        ...
        // 执行测试
        TransformerUtils.insertSegmentObjectToEvents(mockDatabaseService, segment, invalidFields, missingFields); // 验证字段设置
